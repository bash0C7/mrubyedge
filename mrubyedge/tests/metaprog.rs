...
fn instance_variable_defined_after_it_is_set_test() {
    ...
    ";
    assert!(run_test_main_b("instance_variable_defined", code));
}
...
fn instance_variables_lists_the_set_ivar_test() {
    ...
    ";
    assert!(run_test_main_b("instance_variables_include", code));
}
...
fn instance_variable_get_reads_the_value_test() {
    ...
    ";
    assert_eq!(run_test_main_i("instance_variable_get", code), 7);
}
...
fn instance_variable_set_updates_the_value_test() {
    ...
    ";
    assert_eq!(run_test_main_i("instance_variable_set", code), 8);
}
...
fn send_test() {
    ...
    ";
    assert_eq!(run_test_main_i("send", code), 7);
}
