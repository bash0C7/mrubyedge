...
// The ENTER n1-bit (block-refusal) tests below build IREPs by hand, the way
// examples/newvm.rs does, since mrbc_compile can't easily be coaxed into
// emitting this exact shape.
